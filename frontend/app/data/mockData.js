...
export const VELOCITY_RADAR_DATA = {
  heatingUp: [
    {
      from: "DEL",
      to: "GOI",
      ...
      paxVolume: "450K",
      volatility: "High",
      reason: "Leisure seasonal compression & weekend slot scarcity",
    },
    {
      from: "BOM",
      to: "CCU",
      ...
      paxVolume: "740K",
      volatility: "Medium",
      reason: "High corporate load factor across morning banks",
    },
    {
      from: "BLR",
      to: "DEL",
      ...
      paxVolume: "950K",
      volatility: "Medium",
      reason: "Tech corridor demand surge & evening slot congestion",
    },
    {
      from: "DEL",
      to: "SXR",
      ...
      paxVolume: "190K",
      volatility: "High",
      reason: "Mountain valley weather restrictions & high load factor",
    },
    {
      from: "HYD",
      to: "BOM",
      ...
      paxVolume: "780K",
      volatility: "Low",
      reason: "Steady business volume across nonstop frequencies",
    },
  ],
  coolingDown: [
    {
      ...
      paxVolume: "390K",
      volatility: "Low",
      reason: "New capacity deployment & competitive Akasa discounting",
    },
    {
      from: "BOM",
      to: "AMD",
      ...
      paxVolume: "370K",
      volatility: "Low",
      reason: "Vande Bharat rail modal competition & off-peak fare cuts",
    },
    {
      from: "MAA",
      to: "BLR",
      ...
      paxVolume: "600K",
      volatility: "Low",
      reason: "High frequency feeder pricing with excess available inventory",
    },
    {
      from: "CCU",
      to: "GAU",
      ...
      paxVolume: "310K",
      volatility: "Low",
      reason: "UDAN regional connectivity subsidy expansion",
    },
    {
      from: "BLR",
      to: "COK",
      ...
      paxVolume: "230K",
      volatility: "Low",
      reason: "South-Peninsula shoulder season fare stabilization",
    },
  ],
};
