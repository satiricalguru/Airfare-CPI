...
const HUBS_CONFIG = [
  // Tier-1 National Hubs (Real 2026 Monthly Domestic Passenger Volumes)
  { code: "DEL", city: "New Delhi", state: "Delhi", x: 186.5, y: 210.0, pax: "4.10M", cpi: 106.0, trafficWeight: 1.0, zone: "North", labelPos: "top" },
  { code: "BOM", city: "Mumbai", state: "Maharashtra", x: 140.0, y: 434.0, pax: "2.85M", cpi: 107.4, trafficWeight: 0.95, zone: "West", labelPos: "left" },
  { code: "BLR", city: "Bengaluru", state: "Karnataka", x: 198.0, y: 562.0, pax: "2.60M", cpi: 107.5, trafficWeight: 0.92, zone: "South", labelPos: "bottom" },
  { code: "HYD", city: "Hyderabad", state: "Telangana", x: 236.0, y: 456.0, pax: "1.75M", cpi: 105.8, trafficWeight: 0.85, zone: "South", labelPos: "right" },
  { code: "CCU", city: "Kolkata", state: "West Bengal", x: 416.0, y: 348.0, pax: "1.40M", cpi: 108.2, trafficWeight: 0.80, zone: "East", labelPos: "right" },
  { code: "MAA", city: "Chennai", state: "Tamil Nadu", x: 246.0, y: 560.0, pax: "1.25M", cpi: 106.8, trafficWeight: 0.76, zone: "South", labelPos: "right" },

  // Key State Capitals & Major Commercial Centers
  { code: "AMD", city: "Ahmedabad", state: "Gujarat", x: 82.0, y: 342.0, pax: "820K", cpi: 106.2, trafficWeight: 0.65, zone: "West", labelPos: "left" },
  { code: "GOI", city: "Goa", state: "Goa", x: 122.0, y: 512.0, pax: "760K", cpi: 109.1, trafficWeight: 0.68, zone: "West", labelPos: "left" },
  { code: "PNQ", city: "Pune", state: "Maharashtra", x: 156.0, y: 448.0, pax: "710K", cpi: 105.4, trafficWeight: 0.62, zone: "West", labelPos: "right" },
  { code: "COK", city: "Kochi", state: "Kerala", x: 175.0, y: 615.0, pax: "540K", cpi: 104.5, trafficWeight: 0.60, zone: "South", labelPos: "left" },
  { code: "GAU", city: "Guwahati", state: "Assam", x: 486.0, y: 268.0, pax: "490K", cpi: 107.8, trafficWeight: 0.56, zone: "North-East", labelPos: "top" },
  { code: "LKO", city: "Lucknow", state: "Uttar Pradesh", x: 278.0, y: 254.0, pax: "460K", cpi: 106.4, trafficWeight: 0.58, zone: "North", labelPos: "top" },
  { code: "JAI", city: "Jaipur", state: "Rajasthan", x: 146.0, y: 248.0, pax: "430K", cpi: 105.6, trafficWeight: 0.55, zone: "North", labelPos: "left" },
  { code: "BBI", city: "Bhubaneswar", state: "Odisha", x: 360.0, y: 418.0, pax: "380K", cpi: 105.9, trafficWeight: 0.54, zone: "East", labelPos: "right" },
  { code: "PAT", city: "Patna", state: "Bihar", x: 366.0, y: 272.0, pax: "360K", cpi: 107.1, trafficWeight: 0.52, zone: "East", labelPos: "top" },
  { code: "SXR", city: "Srinagar", state: "Jammu and Kashmir", x: 168.0, y: 65.0, pax: "320K", cpi: 105.1, trafficWeight: 0.46, zone: "North", labelPos: "top" },
  { code: "IXC", city: "Chandigarh", state: "Chandigarh", x: 180.0, y: 160.0, pax: "290K", cpi: 104.8, trafficWeight: 0.48, zone: "North", labelPos: "top" },
  { code: "IDR", city: "Indore", state: "Madhya Pradesh", x: 162.0, y: 350.0, pax: "270K", cpi: 105.8, trafficWeight: 0.48, zone: "Central", labelPos: "left" },
  { code: "VNS", city: "Varanasi", state: "Uttar Pradesh", x: 326.0, y: 268.0, pax: "260K", cpi: 106.7, trafficWeight: 0.50, zone: "North", labelPos: "bottom" },
  { code: "TRV", city: "Thiruvananthapuram", state: "Kerala", x: 188.0, y: 654.0, pax: "250K", cpi: 104.9, trafficWeight: 0.48, zone: "South", labelPos: "bottom" },
  { code: "IXR", city: "Ranchi", state: "Jharkhand", x: 356.0, y: 334.0, pax: "220K", cpi: 105.7, trafficWeight: 0.46, zone: "East", labelPos: "right" },
  { code: "VTZ", city: "Visakhapatnam", state: "Andhra Pradesh", x: 318.0, y: 462.0, pax: "210K", cpi: 106.3, trafficWeight: 0.46, zone: "South", labelPos: "right" },
  ...
  { code: "IXB", city: "Bagdogra", state: "Sikkim", x: 422.0, y: 242.0, pax: "190K", cpi: 108.4, trafficWeight: 0.44, zone: "East", labelPos: "top" },
  { code: "DED", city: "Dehradun", state: "Uttarakhand", x: 215.0, y: 172.0, pax: "160K", cpi: 106.8, trafficWeight: 0.42, zone: "North", labelPos: "top" },
  { code: "BHO", city: "Bhopal", state: "Madhya Pradesh", x: 202.0, y: 346.0, pax: "150K", cpi: 105.3, trafficWeight: 0.45, zone: "Central", labelPos: "left" },
  ...
  { code: "IXZ", city: "Port Blair", state: "Andaman and Nicobar Islands", x: 532.0, y: 590.0, pax: "130K", cpi: 111.4, trafficWeight: 0.40, zone: "Islands", labelPos: "left" },
  { code: "IXL", city: "Leh", state: "Ladakh", x: 212.0, y: 82.0, pax: "110K", cpi: 110.2, trafficWeight: 0.38, zone: "North", labelPos: "top" },
  { code: "IMF", city: "Imphal", state: "Manipur", x: 536.0, y: 308.0, pax: "95K", cpi: 107.2, trafficWeight: 0.34, zone: "North-East", labelPos: "right" },
  { code: "VGA", city: "Vijayawada", state: "Andhra Pradesh", x: 272.0, y: 486.0, pax: "90K", cpi: 105.5, trafficWeight: 0.42, zone: "South", labelPos: "right" },
  { code: "DMU", city: "Dimapur", state: "Nagaland", x: 540.0, y: 268.0, pax: "45K", cpi: 107.6, trafficWeight: 0.31, zone: "North-East", labelPos: "right" },
  { code: "AJL", city: "Aizawl", state: "Mizoram", x: 518.0, y: 348.0, pax: "35K", cpi: 108.1, trafficWeight: 0.30, zone: "North-East", labelPos: "right" },
  { code: "SHL", city: "Shillong", state: "Meghalaya", x: 478.0, y: 292.0, pax: "20K", cpi: 107.0, trafficWeight: 0.28, zone: "North-East", labelPos: "bottom" },
];
